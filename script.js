 ...
 */
var abc = 'a';
console.log('a: ' +abc.charCodeAt(0));

var zabc = 'z';
console.log('z: ' +zabc.charCodeAt(0));
...
const searchForAlphabeticalIndex = ([stringToFindIndexForFirstLetter], alphabetArray = generateAlphabetArray()) => {
  console.log(stringToFindIndexForFirstLetter);
  ...
  console.log('first letter: '+stringToFindIndexForFirstLetter);
  ...
  let recursiveBinarySearch = (array, letter, startIndex, endIndex) => {
      ...
      console.log('Letra encontrada: ' + array[midIndex]);
